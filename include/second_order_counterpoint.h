...
public:
  ...
  static void analyse_and_add_interval(bool reverse_movement, bool melodic_ascendant, vector<Interval> & possible_intervals, Note previous_counterpoint_note, Note previous_note, Note note, Interval interval, Scale & scale);
